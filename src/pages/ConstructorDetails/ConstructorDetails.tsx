        ...
        <IonPage>
            ...
            {constructor && (
                <IonContent>
                    <IonList lines="full">
                        <IonItem>
                            <IonIcon lazy slot="start" size="large" className="constructor"
                                     src={`https://bucketofflags103632-staging.s3.amazonaws.com/constructors/${constructor.ConstructorStandings[0].Constructor.constructorId}.svg`}/>
                            <IonLabel>
                                <p>Team</p>
                        ...
                        {drivers && drivers.slice(0, 2).map(driver =>
                            <IonItem button routerLink={`/driver/${driver.driverId}`} key={driver.driverId}>
                                ...
                                <IonThumbnail slot="end" className="country-thumbnail">
                                    <IonImg
                                        src={`https://bucketofflags103632-staging.s3.amazonaws.com/flags/${driver.nationality}.svg`}
